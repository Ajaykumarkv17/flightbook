...
const Airplane = () => {
  ...
  const loadData =async()=>{
    const response= await Axios.get('https://flightapp-fq75.onrender.com/airplane/api/get');
  ...
  const delAirplane=(id)=>{
    ...
    {
      Axios.delete(`https://flightapp-fq75.onrender.com/airplane/api/remove/${id}`);

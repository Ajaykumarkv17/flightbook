...
const AddEditSchedule = () => {
  ...
  useEffect(() => {
    Axios.get(`https://flightapp-fq75.onrender.com/schedule/api/get/${id}`).then((resp) =>
  ...
  const handleSubmit = (event) => {
    ...
    if (!schedule_id || !departure_time || !arrival_time || !duration_time)
      ...
      if (!id) {
        Axios.post("https://flightapp-fq75.onrender.com/api/post", {
          schedule_id,
          departure_time,
          arrival_time,
          duration_time,
        ...
        Axios.put(`https://flightapp-fq75.onrender.com/schedule/api/update/${id}`, {
            schedule_id,
            departure_time,
            arrival_time,
            duration_time,

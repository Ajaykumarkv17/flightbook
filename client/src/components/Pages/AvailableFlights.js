...
const AvailableFlights = () => {
  ...
  const loadData = async () => {
    const response = await Axios.get("https://flightapp-fq75.onrender.com/SearchFlights");
    ...
    const Returnresponse=await Axios.post("https://flightapp-fq75.onrender.com/AvailableFlights",{
